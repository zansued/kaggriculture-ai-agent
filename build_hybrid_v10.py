"""Build do bundle single-file do HÍBRIDO V10: Moon V56 + overlays do mix +
glut-guard com dump_floor POR ITEM + janela ANTECIPADA 190-650.

V10 = hybrid_v6 com ÚNICA mudança: _GSTART 250 -> 190.
  - Justificativa: melon crasha pós-dia 10 (~step 240); o glut_guard do v6
    começava em 250, DEPOIS do crash, perdendo a janela de vender melon em
    preço bom. Antecipar para 190 (~dia 8) captura o melon/strawberry antes
    do colapso (price >= base*0.40).
  - Resto idêntico ao v6 (dump_floor por item, front-run, sell_first).

Output: submissions/hybrid_v10/main.py
Usage:   python build_hybrid_v10.py
"""
...
OUT = ROOT / "submissions" / "hybrid_v10" / "main.py"
...
def build() -> None:
    ...
    header = f'''"""hybrid_v10 - single-file Kaggle submission bundle.
...
janela ANTECIPADA 190-650 (captura melon antes do crash pós-d10).

Built by build_hybrid_v10.py. Self-contained: embute moon_agent_main.py

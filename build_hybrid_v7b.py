"""Build do bundle single-file do HÍBRIDO V7b: Moon V56 + overlays do mix +
glut-guard com dump_floor POR ITEM REDUZIDO + janela 250-650.

V7b = hybrid_v6 com ÚNICA mudança: _GD_FLOOR mais baixo (dump mais agressivo):
  - MILK/WOOL 0.45 -> 0.30
  - MELON/STRAWBERRY 0.40 -> 0.25
  - _GHOLD 0.5, _GSTART 250, _GSTOP 650, front-run e sell_first: idênticos ao v6.

Justificativa (diagnóstico do v7, 25/08): v7 elevou os floors cedo e segurou
estoque em preços bons, perdendo janela de venda antes do colapso (MILK 175->7,
WOOL 212->5, MELON crash pós-d10, STRAWB crash pós-d21). Hipótese: vender MAIS
cedo/agressivo captura preço melhor. Isola APENAS o efeito do dump floor.

Output: submissions/hybrid_v7b/main.py
Usage:   python build_hybrid_v7b.py
"""
...
OUT = ROOT / "submissions" / "hybrid_v7b" / "main.py"
...
_GD_FLOOR = {"MILK": 0.30, "WOOL": 0.30, "MELON": 0.25, "STRAWBERRY": 0.25}
_GSTART = 250
_GSTOP = 650
...
def build() -> None:
    ...
    header = f'''"""hybrid_v7b - single-file Kaggle submission bundle.

Moon V56 + overlays do mix (maturity front-run + order-slot sell-first) +
glut-guard com dump_floor POR ITEM REDUZIDO (MILK/WOOL 0.30,
MELON/STRAWBERRY 0.25) e janela 250-650. Resto idêntico ao v6.

Built by build_hybrid_v7b.py. Self-contained: embute moon_agent_main.py

"""Build do bundle single-file do HÍBRIDO V17 (GOOSE expandido): Moon V56 (com _v35
alargado: GOOSE ativa com 1+ loja de EGG em vez de 2+) + overlays do mix +
glut-guard com dump_floor POR ITEM + janela 250-650.

V6 = hybrid_v5 + front-run MELON/STRAWBERRY mais cedo:
  - _OPP_THRESH: STRAWBERRY 6->4, MELON 4->2 (MILK/WOOL mantidos)
  - Justificativa: melons/strawberries do oponente crasham rápido; preemptar
    com poucas unidades maduras captura preço melhor antes do glut.

Validado (engine 1.32.7, seeds 1-36, espelho):
  - v6 vs v5: 33W-12L (de 72 jogos, 2 lados)
  Cadeia: v2 -> v4 (17-9) -> v5 (27-8 vs v4) -> v6 (33-12 vs v5).

Estrutura: embute research/public/moon_v17_goose.py (stdlib-only) como blob
zlib+base85, e injeta inline os overlays do mix_agent (mature_opp_front_run,
sell_first) MAIS o _glut_guard com dump_floor por item.

Output: submissions/hybrid_v17/main.py
Usage:   python build_hybrid_v17.py
"""
...
OUT = ROOT / "submissions" / "hybrid_v17" / "main.py"
...
def build() -> None:
    ...
    header = f'''"""hybrid_v5 - single-file Kaggle submission bundle.

Moon V56 (public 2736-2913) + overlays do mix (maturity front-run + order-slot
sell-first) + glut-guard com dump_floor POR ITEM (MILK/WOOL 0.45,
MELON/STRAWBERRY 0.40) e janela 250-650.
Validado: 27W-8L vs hybrid_v4 (P0=v5, 36 seeds).

Built by build_hybrid_v17.py. Self-contained: embute moon_v17_goose.py

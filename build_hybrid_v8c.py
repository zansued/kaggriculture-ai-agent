"""Build do bundle single-file do HÍBRIDO V8c: Moon V56 + overlays do mix +
glut-guard com dump_floor POR ITEM + front-run CALIBRADO FINO.

V8c = hybrid_v6 com ÚNICA mudança: _OPP_THRESH UM DEGRAU mais conservador:
  - STRAWBERRY 4 -> 5
  - MELON 2 -> 3
  - MILK 4 / WOOL 3: mantidos
  - _OPP_MAX_DAY, glut-guard, sell_first: idênticos ao v6.

Justificativa (série 25/08): mapa da sensibilidade = v5(6/4) < v6(4/2) e
v8(2/1) < v6; v8b(seletivo max_day) < v6. Testar o degrau intermediário entre
v5 e v6: STRAWB 5 / MELON 3. Hipótese: v6 pode estar levemente no lado
"sensível demais" para alguns oponentes; um degrau conservador pode equilibrar.

Output: submissions/hybrid_v8c/main.py
Usage:   python build_hybrid_v8c.py
"""
...
OUT = ROOT / "submissions" / "hybrid_v8c" / "main.py"
...
# ---------------------------------------------------------------------------
_OPP_THRESH = {"STRAWBERRY": 5, "MELON": 3, "MILK": 4, "WOOL": 3}
...
def build() -> None:
    ...
    header = f'''"""hybrid_v8c - single-file Kaggle submission bundle.
...
janela 250-650. Front-run calibrado fino: _OPP_THRESH STRAWB 5 / MELON 3.

Built by build_hybrid_v8c.py. Self-contained: embute moon_agent_main.py

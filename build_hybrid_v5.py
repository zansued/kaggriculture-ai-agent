"""Build do bundle single-file do HÍBRIDO V5: Moon V56 + overlays do mix +
glut-guard com dump_floor POR ITEM + janela 250-650.

V5 = hybrid_v4 + calibração do dump_floor por item (cada colapsante tem
timing de crash próprio):
  - MILK:  0.45  (pico d13, colapso tardio)
  - WOOL:  0.45  (dip e recupera p/ late $244)
  - MELON: 0.40  (crash pós-d10, cedo)
  - STRAWBERRY: 0.40  (crash pós-d21)
  - janela: 250-650 (mesma do v4)

Validado (engine 1.32.7, seeds 1-36, vs hybrid_v4):
  - v5 (P0) vs v4: 27W-8L (+7800)
  Cadeia: v2 -> v4 (17-9) -> v5 (27-8 vs v4).
...
Output: submissions/hybrid_v5/main.py
Usage:   python build_hybrid_v5.py
"""
...
OUT = ROOT / "submissions" / "hybrid_v5" / "main.py"
...
# dump_floor POR ITEM: MILK/WOOL 0.45, MELON/STRAWBERRY 0.40. Validado 27W-8L
# vs v4 (36 seeds).
# ---------------------------------------------------------------------------
...
Built by build_hybrid_v5.py. Self-contained: embute moon_agent_main.py
